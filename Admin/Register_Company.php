		...
		<div class="container">
			...
			<div class="top-nav">
				...
				<ul class="nav1">
					...
					<li><a href="Register_Company.php" class="active">Register</a></li>
                         ...
                         <div class="company_body">
                           <table width="564" border="0">
                             <tr>
                               ...
                               <td width="236"><input type="email" name="email" id="email" required></td>
                             </tr>
                             <tr>
                             ...
                             <tr>
                               ...
                               <td><input type="radio" name="sales" id="sales" value="yes" required>
                                 Yes
                            ...
                            <td><input type="text" name="sales_name" id="sales_name" required></td>
                           </table>
            </div>
                <div class="company_header">
...
?>
                           <table width="647" border="0">
                             ...
                             <tr>
                               ...
                               <td><select name="industry[]" size="7" multiple id="industry" required>
                             ...
                             <tr>
                               ...
                               <td><textarea name="company_description" id="company_description" cols="45" rows="5" required></textarea></td>
                             </tr>
                             <tr>
                               <th height="35">* Country</th>
                               <td><select name="country" id="country" onChange="msg(this.value)" required>
                               <option value="">--select--</option>
                               <?php
                             ...
                             <tr>
                               ...
                               <td><input type="text" name="registration_no" id="registration_no" required></td>
                             </tr>
                             <tr>
                               <th>* Address :</th>
                               <td><textarea name="address" id="address" cols="45" rows="5" required></textarea></td>
                             </tr>
                           </table>
            </div>
                        <div class="company_header">
                        ...
                        <div class="company_body">
                          <table width="722" border="0">
                            <tr>
                              ...
                              <td width="396"><input type="text" name="first_name" id="first_name" required></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td>+<input type="number" name="code" id="code" maxlength="4" width="35px" required>
                              <input type="number" name="mobile" id="mobile" required pattern="[0-9]{10}"></td>
                            </tr>
                            <tr>
